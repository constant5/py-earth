        ...
        ext_modules = cythonize(
            [
                Extension(
                    ...
                    define_macros=[("NPY_NO_DEPRECATED_API", "NPY_1_7_API_VERSION"), ("Pyfloatype", "PyFloat_Type")],
                ),
                Extension(
                    "pyearth._basis",
                    ["pyearth/_basis.pyx"],
...
def setup_package():
    ...
    setup_args = {
        ...
        "install_requires": ["scipy >= 0.16", "scikit-learn >= 0.16", "six"],
        "extras_require": {
            "docs": ["sphinx_gallery"],
            "dev": ["cython"],
            "export": ["sympy"],
    ...
    def is_special_command():
        special_list = ("--help-commands", "egg_info", "--version", "clean")
        return "--help" in sys.argv[1:] or sys.argv[1] in special_list
